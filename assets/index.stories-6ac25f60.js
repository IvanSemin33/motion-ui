import{j as M}from"./wrapper-3316f290.js";import{r as U}from"./index-76fb7be0.js";import{E as p,d as q,b as _,l as Q,s as W,v as w,f as B}from"./argTypes-95f67a8a.js";import{R as T,E as i,a as h,b as n}from"./index-7695b5fc.js";import"./_commonjsHelpers-de833af9.js";import"./index.esm-1eb8ea43.js";const Z={title:"Inputs/Radio",component:T,zeplinLink:"",parameters:{controls:{sort:"requiredFirst"}},argTypes:{checked:{control:{type:"boolean"},description:"Whether the radio is checked",table:{category:p.STATE,type:{summary:"boolean"}}},disabled:q,isFetching:_,label:Q,shape:{control:{type:"radio",options:Object.values(i)},description:"The shape of the radio",table:{category:p.APPEARANCE,type:{summary:"ERadioShapes"},defaultValue:{summary:i.CIRCLE}}},size:W({sizes:h,defaultValue:h.MEDIUM,typeName:"ERadioSizes"}),variant:w({variants:n,defaultValue:n.FILLED,typeName:"ERadioVariants"}),onChange:B}},a=N=>{const[O,V]=U.useState(!1);return M.jsx(T,{...N,checked:O,onChange:j=>V(j.target.checked)})},e=a.bind({});e.args={disabled:!1,size:h.MEDIUM,variant:n.STANDARD,shape:i.CIRCLE};const s=a.bind({});s.args={...e.args,variant:n.FILLED};const r=a.bind({});r.args={...e.args,variant:n.OUTLINED};const c=a.bind({});c.args={...e.args,disabled:!0};const t=a.bind({});t.args={...e.args,shape:i.SQUARE};const o=a.bind({});o.args={...e.args,label:"Label"};const d=a.bind({});d.args={...e.args,isFetching:!0};var g,u,k;e.parameters={...e.parameters,docs:{...(g=e.parameters)==null?void 0:g.docs,source:{originalSource:`args => {
...
//# sourceMappingURL=index.stories-6ac25f60.js.map
